...
function addToCart2(){
  sth = sth+1;
  document.getElementById("cart").innerHTML = "(" + sth + ")";
}

function valid() {
  var prod_title =  document.getElementById("prod_title").value;

  if (prod_title.length < 2) {  
   document.getElementById("prod_title_err").innerHTML = "title invalid: must contain only alphabets";
   return false;
}
}
/*
          a function to validate upload request
         */
      ...
      /////////////////////////////////////////////////////////////////////////////////
      /*
      a function to validate product tile. 
