...
<div id="sidebar" class="span3">
		...
		<ul id="sideManu" class="nav nav-tabs nav-stacked">
			<li class="subMenu open"><a> Products [230]</a>
				<ul>
				<li><a class="active" href="view/products.php"><i class="icon-chevron-right"></i>Toiletry (100) </a></li>
				<li><a href="view/products.php"><i class="icon-chevron-right"></i>Linen (30)</a></li>
				<li><a href="view/products.php"><i class="icon-chevron-right"></i>Footwear(80)</a></li>
				<li><a href="view/products.php"><i class="icon-chevron-right"></i>Jewellery  (15)</a></li>
				</ul>
			</li>
